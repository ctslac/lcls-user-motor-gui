...
class QDataclassBridge(QObject):
    ...
    def set_field_from_data(
        self, name: str, type_hint: Any, data: Any, optional: bool = False
    ):
        """
...
class QDataclassValue(QDataclassElem):
    ...
    @classmethod
    def of_type(cls, data_type: type, optional: bool = False) -> Type[QDataclassValue]:
        """
...
class QDataclassList(QDataclassElem):
    ...
    @classmethod
    def of_type(cls, data_type: type, optional: bool = False) -> Type[QDataclassList]:
        """
        Create a QDataclass with a specific QSignal
